...
func BuildApplication() (*app.Application, error) {
	...
	registry := &Registry{Config: cfg, DB: db, Router: groups.API, Public: groups.Public, Admin: groups.Admin, AdminAuth: groups.AdminAuth, Providers: providers}
	...
	return &app.Application{Config: cfg, Router: groups.Engine}, nil
}
